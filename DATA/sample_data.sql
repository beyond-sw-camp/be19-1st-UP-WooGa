...
VALUES
    ('user01', 'user02', '대여 가능일 문의', '안녕하세요! 혹시 이 제품 언제부터 언제까지 대여 가능한가요?'),
    ('user02', 'user01', '대여 희망 기간 조정 요청', '제가 원하는 날짜에 일정이 안 맞을 것 같아 다른 날짜로 조정 가능할까요?'),
    ('user07', 'user08', '제품 수령 위치 문의', '안녕하세요! 혹시 제품 수령은 어디에서 가능한가요?');